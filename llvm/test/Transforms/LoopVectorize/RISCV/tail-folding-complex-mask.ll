...
; NO-VP:       [[LOAD_V210]]:
; NO-VP-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i32, ptr [[SRC2]], i64 [[INDEX]]
; NO-VP-NEXT:    [[WIDE_MASKED_LOAD7:%.*]] = load <vscale x 4 x i32>, ptr [[TMP16]], align 4
...
; NO-VP-NEXT:    [[TMP23:%.*]] = phi <vscale x 4 x i1> [ zeroinitializer, %[[LOAD_V17]] ], [ splat (i1 true), %[[LOAD_V210]] ]
