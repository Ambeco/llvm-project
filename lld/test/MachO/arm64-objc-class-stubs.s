...
# classes, autolinked archives, dynamic lookup, malformed names, and missing classes.

# RUN: rm -rf %t && split-file %s %t

# Check fast and small stubs for regular, local class, and dylib class calls.
...
# RUN: llvm-objdump --no-leading-addr --no-show-raw-insn --section=__TEXT,__objc_stubs \
...
#--- main.s
# Main fast/small case: one regular selector stub plus local and dylib class stubs.
